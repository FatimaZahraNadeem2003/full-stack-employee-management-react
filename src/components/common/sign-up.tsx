...
interface SignUpProps {
    image: string
    handlesignupform: (event: React.ChangeEvent<HTMLInputElement>) => void
...
export const SignUP = ({ image, handlesignupform, handlesignupsubmit, targetedstate, statevalue, redirectpath }: SignUpProps) => {
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                value={statevalue.contactnumber}
                                onChange={handlesignupform}
                            />
                        </div>
