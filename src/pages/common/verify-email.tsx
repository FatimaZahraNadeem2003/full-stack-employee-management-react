...
interface ResetVerifyEmailPageProps {
  handleverifyemail: (e: React.ChangeEvent<HTMLInputElement>) => void;
  handleverifybutton: (e: React.MouseEvent<HTMLButtonElement>) => void;
  emailvalue: string;
  targetstate: {
    error: {
      status: boolean;
